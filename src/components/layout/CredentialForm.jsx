...
const CredentialForm = ({data, validationErrors = {}}) => {
    ...
    return ( 
        <div className="flex flex-col gap-4 p-6">
            ...
            {emailError && <span style={{ color: 'red', fontSize: 14, marginTop: -15 }}>{emailError}</span>}
            ...
            {passwordError && <span style={{ color: 'red', fontSize: 14, marginTop: -15 }}>{passwordError}</span>}
        </div>
    )
}

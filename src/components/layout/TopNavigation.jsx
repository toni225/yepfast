            ...
            <nav className={`border-gray-200 ${isParkingOwner ? 'bg-PO-Secondary' : 'bg-VO-Secondary'}`}>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <span
                            className={`self-center text-2xl font-['Poppins'] whitespace-nowrap ${isParkingOwner ? 'text-PO-Tertiary' : 'text-VO-Tertiary'}`}>PFASt</span>
                    </a>
                        ...
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                            ...
                            {isLogin ?
                                <li>
                                    <NavLink
                                        to={'/account'}
                                        className={`font-['Poppins'] block py-2 px-3 ${isParkingOwner ? 'text-PO-Tertiary' : 'text-VO-Tertiary'} rounded md:border-0 md:hover:text-white md:p-0`}
                                    >Account</NavLink>
                                </li>
                                :
                                <li>
